...
-- CreateEnum
CREATE TYPE "TeamRole" AS ENUM ('LEADER', 'AGENT');
...
CREATE TABLE "TagsOnTickets" (
    ...
    CONSTRAINT "TagsOnTickets_pkey" PRIMARY KEY ("ticketId","tagId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "TicketMetadata_ticketId_key_key" ON "TicketMetadata"("ticketId", "key");
...
-- AddForeignKey
ALTER TABLE "TagsOnTickets" ADD CONSTRAINT "TagsOnTickets_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "Ticket"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TagsOnTickets" ADD CONSTRAINT "TagsOnTickets_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "Tag"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
